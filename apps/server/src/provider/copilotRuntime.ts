...
const EMPTY_COPILOT_MODEL_CAPABILITIES: ModelCapabilities = createModelCapabilities({
  optionDescriptors: [],
});
...
export class CopilotProbePromiseError extends Schema.TaggedError<CopilotProbePromiseError>()(
...
export class CopilotClientStopError extends Schema.TaggedError<CopilotClientStopError>()(
...
class CopilotClientStopPromiseError extends Schema.TaggedError<CopilotClientStopPromiseError>()(
...
class CopilotCliPathResolutionError extends Schema.TaggedError<CopilotCliPathResolutionError>()(
